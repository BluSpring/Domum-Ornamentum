...
public sealed class ChunkRenderTypeSet implements Iterable<RenderType>
{
    ...
    private static ChunkRenderTypeSet of(Iterable<RenderType> renderTypes)
    {
        ...
        {
            int index = ((RenderTypeExtension) renderType).domum$getChunkRenderLayerId();
    ...
    {
        int id = ((RenderTypeExtension) renderType).domum$getChunkRenderLayerId();
    ...
    private static final class All extends ChunkRenderTypeSet
    {
        ...
        public boolean contains(RenderType renderType)
        {
            return ((RenderTypeExtension) renderType).domum$getChunkRenderLayerId() >= 0; // Could just return true for efficiency purposes, but checking is near-free
        }
