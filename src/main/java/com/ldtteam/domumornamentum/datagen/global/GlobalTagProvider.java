...
public class GlobalTagProvider extends BlockTagProvider
{
    public GlobalTagProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
